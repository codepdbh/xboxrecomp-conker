 ...
 * pointers. Games can override these defaults with compile definitions.
 * Kernel thunks at 0xFE000000+ must NOT be blocked.
 */
#ifndef RECOMP_CODE_VA_START
#define RECOMP_CODE_VA_START 0x00010000u
#endif
#ifndef RECOMP_CODE_VA_END
#define RECOMP_CODE_VA_END   0x00400000u
#endif

#define RECOMP_INVALID_CODE_VA(va) \
    (((va) < RECOMP_CODE_VA_START || (va) >= RECOMP_CODE_VA_END) && \
     (va) < 0xFE000000u)
